...
class SearchResultTableCellView: UITableViewCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String!) {
        ...
        reviewCountLabel.font = reviewCountLabel.font.fontWithSize(11.5)
        ...
        addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("V:|-10-[image(80)]-10-|", options: nil, metrics: nil, views: viewsDict))
        ...
        addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("V:|-10-[name]-3-[rating(20)]", options: nil, metrics: nil, views: viewsDict))
        addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("H:[image]-10-[rating]-3-[reviews]", options: nil, metrics: nil, views: viewsDict))
        addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("V:[name]-6-[reviews]", options: nil, metrics: nil, views: viewsDict))
        ...
        addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("H:[image]-10-[address]", options: nil, metrics: nil, views: viewsDict))
        addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("V:[address]-3-[categories]", options: nil, metrics: nil, views: viewsDict))
        addConstraints(NSLayoutConstraint.constraintsWithVisualFormat("H:[image]-10-[categories]", options: nil, metrics: nil, views: viewsDict))
    }
